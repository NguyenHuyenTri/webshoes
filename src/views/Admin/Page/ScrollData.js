...
export default function SrollBar(temp) {



    const dataScrollHome = temp.tempData;
    const productList= temp.tempProduct;
    const local = temp.tempLocal;
    const  title= temp.templeTitle;
